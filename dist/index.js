      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between gap-3 px-3 pb-2 pt-1 text-[11px] font-medium text-muted-foreground", children: /* @__PURE__ */ jsx("span", { children: pending?.from && !pending.to ? `In\xEDcio: ${fmt(pending.from)}. Agora clique no fim.` : "Clique no in\xEDcio e depois no fim do per\xEDodo" }) })
          ]
        }
      ),
