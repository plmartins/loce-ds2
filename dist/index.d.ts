...
declare function Input({ className, label, error, hint, labelAction, suffix, onClear, loading, id, ...props }: InputProps): react.JSX.Element;
...
declare function Select({ options, value, onChange, placeholder, label, labelAction, error, loading, disabled, className }: SelectProps): react.JSX.Element;
 ...
 */
declare function DateRangePicker({ label, value, onChange, placeholder, error, disabled, clearable, className, minDate, maxDate, numberOfMonths, defaultOpen, presets, activePresetKey, displayLabel, onPresetSelect, }: DateRangePickerProps): react.JSX.Element;
