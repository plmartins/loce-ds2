...
declare function Select({ className, options, placeholder, ...props }: SelectProps): react.JSX.Element;
...
export { type Action, AppShell, type AppShellProps, Badge, type BadgeProps, Button, type ButtonProps, type Column, DataTable, type DataTableProps, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuTrigger, HeaderBar, type HeaderBarProps, Input, type InputProps, PageShell, type PageShellProps, PaginationBar, type PaginationBarProps, type PlatformId, PlatformRail, type PlatformRailItem, type PlatformRailProps, SearchInput, type SearchInputProps, Select, type SelectOption, type SelectProps, SidebarNav, type SidebarNavGroup, type SidebarNavProps, type SidebarNavSubItem, Switch, type SwitchProps, ThemeToggle, type ThemeToggleProps, badgeVariants, buttonVariants, cn, fieldClass, useShell };
