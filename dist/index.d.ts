 ...
 */
declare function DateRangePicker({ label, value, onChange, placeholder, error, disabled, clearable, className, minDate, maxDate, numberOfMonths, }: DateRangePickerProps): react.JSX.Element;
