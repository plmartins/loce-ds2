 ...
 */
declare function RailUser({ name, email, avatarUrl, badge, children, className }: RailUserProps): react.JSX.Element;
 ...
 */
declare function FaceAvatar({ seed, glyph, src, size, className, title }: FaceAvatarProps): react.JSX.Element;
