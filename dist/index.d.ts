...
type PlatformId = "erp" | "ecommerce" | "marketing" | "talkbia" | "dev";
...
type RailUserProps = {
    ...
    /** Conta ainda carregando: avatares mostram placeholder animado. */
    loading?: boolean;
 ...
 */
declare function RailUser({ name, email, avatarUrl, loading, badge, children, className }: RailUserProps): react.JSX.Element;
...
declare const isFilterActive: (value: unknown) => boolean;

declare const fieldClass: string;
type InputProps = ComponentProps<"input"> & FilterStateProps & {
    label?: string;
    error?: string;
...
declare function Input({ className, label, error, hint, labelAction, suffix, onClear, loading, id, filterActive, ...props }: InputProps): react.JSX.Element;

type SearchInputProps = InputHTMLAttributes<HTMLInputElement> & FilterStateProps & {
    /** Mostra o chip "Limpar" e dispara ao clicar. */
    onClear?: () => void;
    showClear?: boolean;
};
declare function SearchInput({ className, onClear, showClear, filterActive, ...props }: SearchInputProps): react.JSX.Element;

type SelectOption = {
    value: string | number;
    label: string;
};
type SelectProps = FilterStateProps & {
...
declare function Select({ options, value, onChange, placeholder, label, labelAction, error, loading, disabled, className, filterActive, onClearFilter }: SelectProps): react.JSX.Element;
type NativeSelectProps = SelectHTMLAttributes<HTMLSelectElement> & FilterStateProps & {
    options: SelectOption[];
    placeholder?: string;
};
/** Select nativo estilizado (popup do SO): útil em mobile e formulários longos. */
declare function NativeSelect({ className, options, placeholder, filterActive, ...props }: NativeSelectProps): react.JSX.Element;
...
declare function Switch({ checked, onCheckedChange, disabled, label, description, className, ...props }: SwitchProps): react.JSX.Element;
...
declare function DropdownMenuContent({ className, sideOffset, onPointerDownCapture, onKeyDownCapture, onCloseAutoFocus, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content>): react.JSX.Element;
 ...
 */
declare function FaceAvatar({ seed, glyph, src, loading, size, className, title }: FaceAvatarProps): react.JSX.Element;
 ...
 */
declare function SplashScreen({ className }: SplashScreenProps): react.JSX.Element;
...
declare function SkeletonCard({ className }: SkeletonProps): react.JSX.Element;
...
declare function MetricCard({ label, value, helper, delta, icon, accent, loading, className }: MetricCardProps): react.JSX.Element;
...
type ComboBoxProps = FilterStateProps & {
 ...
 */
declare function ComboBox({ options, value, onChange, label, labelExtra, error, placeholder, inputValue: controlledInput, onInputChange, minCharsToOpen, disableLocalFilter, isLoading, disabled, emptyText, loadingText, showEmpty, autoFocus, className, filterActive, }: ComboBoxProps): react.JSX.Element;
 ...
 */
declare function ImageUpload({ label, value, onChange, uploadFn, aspect, placeholder, accept, className }: ImageUploadProps): react.JSX.Element;

type DatePickerProps = FilterStateProps & {
    label?: string;
    value?: Date;
...
declare function DatePicker({ label, value, onChange, placeholder, error, disabled, clearable, className, minDate, maxDate, filterActive }: DatePickerProps): react.JSX.Element;
...
type DateRangePickerProps = FilterStateProps & {
    label?: string;
 ...
 */
declare function DateRangePicker({ label, value, onChange, placeholder, error, disabled, clearable, className, filterActive, minDate, maxDate, numberOfMonths, defaultOpen, presets, activePresetKey, displayLabel, onPresetSelect, }: DateRangePickerProps): react.JSX.Element;
...
export { type Action, AppShell, type AppShellProps, Avatar, type AvatarProps, Badge, type BadgeProps, BarList, type BarListItem, type BarListProps, Button, type ButtonProps, Calendar, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, Checkbox, type CheckboxProps, type Column, ComboBox, type ComboBoxOption, type ComboBoxProps, ConfigCard, type ConfigCardProps, DataTable, type DataTableProps, DatePicker, type DatePickerProps, DateRangePicker, type DateRangePickerProps, type DateRangePreset, Dialog, DialogBody, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, type DropdownAction, DropdownActions, type DropdownActionsProps, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, EmptyState, type EmptyStateProps, FaceAvatar, type FaceAvatarProps, type FilterStateProps, HeaderBar, type HeaderBarProps, IconTile, type IconTileProps, type IconTileTone, ImageUpload, type ImageUploadProps, ImageWithZoom, type ImageWithZoomProps, Input, type InputProps, type MetricAccent, MetricCard, type MetricCardProps, type MetricDeltaTone, ModalConfirm, type ModalConfirmProps, ModalDelete, type ModalDeleteProps, MultiSelect, type MultiSelectOption, type MultiSelectProps, NativeSelect, type NativeSelectProps, PageShell, type PageShellProps, PaginationBar, type PaginationBarProps, type PlatformId, PlatformRail, type PlatformRailItem, type PlatformRailProps, RailUser, type RailUserProps, ScrollFade, type ScrollFadeProps, SearchInput, type SearchInputProps, SegmentedControl, type SegmentedControlOption, type SegmentedControlProps, Select, SelectCard, type SelectCardOption, type SelectCardProps, type SelectOption, type SelectProps, Separator, type SeparatorProps, SheetEntity, type SheetEntityProps, SidebarNav, type SidebarNavGroup, type SidebarNavProps, type SidebarNavSubItem, Skeleton, SkeletonCard, SkeletonForm, type SkeletonProps, SkeletonTable, SkeletonText, type SortState, SplashScreen, type SplashScreenProps, StatusDot, type StatusDotProps, Switch, type SwitchProps, type Tab, Tabs, type TabsProps, TagsInput, type TagsInputProps, Text, TextCopy, type TextCopyProps, type TextProps, type TextVariant, Textarea, type TextareaProps, ThemeToggle, type ThemeToggleProps, TimeInput, type TimeInputProps, Timeline, type TimelineItem, type TimelineProps, Toaster, Tooltip, type TooltipProps, badgeVariants, buttonVariants, cn, fieldClass, isFilterActive, textVariantMap, useShell };
