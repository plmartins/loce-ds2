import { IconChevronRight, IconPin, IconMenu, IconMoon, IconSun, IconArrowLeft, IconSpinner, IconSearch, IconClose, IconChevronDown, IconCheck, IconChevronUp, IconSort, IconChevronLeft, IconArrowRight, IconMore, IconChat, IconMarketing, IconCart, IconApps, IconLock } from './chunk-PUD7AYCY.js';
...
function AppShell({ rail, sidebar, mobileSidebar, header, children, className }) {
  ...
  return /* @__PURE__ */ jsx(ShellContext.Provider, { value: { mobileSidebarOpen, setMobileSidebarOpen }, children: /* @__PURE__ */ jsxs("div", { className: cn("flex h-screen overflow-hidden bg-background text-foreground", className), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-1 min-w-0 flex-col min-h-0", children: [
      header,
      /* @__PURE__ */ jsxs("main", { className: "flex-1 min-w-0 min-h-0 flex flex-col overflow-auto", children: [
        children,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-between gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "flex shrink-0 items-baseline gap-1.5", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[13.5px] font-bold tabular-nums", children: item.value }),
                item.share !== void 0 && /* @__PURE__ */ jsxs("span", { className: "text-[11px] font-semibold text-muted-foreground tabular-nums", children: [
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("span", { "aria-hidden": true, className: "pointer-events-none absolute left-1/2 top-[88px] -translate-x-1/2 -translate-y-1/2", children: [
          /* @__PURE__ */ jsx("span", { className: "absolute left-1/2 top-1/2 size-28 -translate-x-1/2 -translate-y-1/2 rounded-full border border-border/80" }),
          /* @__PURE__ */ jsx("span", { className: "absolute left-1/2 top-1/2 size-44 -translate-x-1/2 -translate-y-1/2 rounded-full border border-border/50" }),
          /* @__PURE__ */ jsx("span", { className: "absolute left-1/2 top-1/2 size-60 -translate-x-1/2 -translate-y-1/2 rounded-full border border-border/25" }),
          /* @__PURE__ */ jsx("span", { className: "absolute left-[74px] top-[-10px] size-1.5 rounded-full bg-brand/40" }),
          /* @__PURE__ */ jsx("span", { className: "absolute left-[-86px] top-[26px] size-1 rounded-full bg-brand/30" })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "relative z-10 flex size-14 items-center justify-center rounded-2xl text-white shadow-lg shadow-brand/25 ds-btn-3d [--btn-bg:var(--accent-brand)]", children: icon ?? /* @__PURE__ */ jsx(IconSearch, { size: 24 }) }),
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 mt-5 flex max-w-sm flex-col gap-1", children: [
        ...
        action && /* @__PURE__ */ jsx("div", { className: "relative z-10 mt-4", children: action })
      ]
    }
  );
}

export { AppShell, Avatar, Badge, BarList, Button, DataTable, Dialog, DialogBody, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, EmptyState, HeaderBar, Input, MetricCard, NativeSelect, PageShell, PaginationBar, PlatformRail, SearchInput, SegmentedControl, Select, SidebarNav, Skeleton, SkeletonForm, SkeletonTable, SkeletonText, Switch, TagsInput, ThemeToggle, Tooltip, badgeVariants, buttonVariants, fieldClass, useShell };
