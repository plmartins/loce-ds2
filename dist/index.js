...
function NativeSelect({ className, options, placeholder, filterActive, ...props }) {
  return /* @__PURE__ */ jsxs("div", { className: cn("relative flex items-center", className), children: [
    /* @__PURE__ */ jsxs("select", { "data-filter-active": filterActive || void 0, title: filterActive ? "Filtro ativo" : props.title, className: cn(fieldClass, "cursor-pointer appearance-none pr-8"), ...props, children: [
