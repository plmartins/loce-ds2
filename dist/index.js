    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
          ...
          icon && /* @__PURE__ */ jsx("span", { className: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-brand/10 text-brand", children: icon })
        ] }),
...
function BarList({ items, emptyText = "Nada no per\xEDodo.", className }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("flex flex-col gap-4", className), children: items.map((item, idx) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("group flex flex-col gap-1.5", isZero && "opacity-55"), children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-between gap-3", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "shrink-0 text-[13.5px] font-bold tabular-nums", children: item.value })
      ] }),
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "flex size-12 items-center justify-center rounded-xl bg-brand/10 text-brand", children: icon ?? /* @__PURE__ */ jsx(IconSearch, { size: 22 }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex max-w-sm flex-col gap-1", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[14px] font-bold", children: title }),
