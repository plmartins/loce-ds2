import { IconLock, IconChevronRight, IconPin, IconMenu, IconMoon, IconSun, IconArrowLeft, IconSpinner, IconClose, IconSearch, IconFilters, IconChevronDown, IconCheck, IconChevronUp, IconSort, IconChevronLeft, IconArrowRight, IconCopy, IconMore, IconTrash, IconPlus, IconCursorClick, IconMouse, IconHandGrab, IconRefresh, IconUpload, IconCalendar, IconCode, IconChat, IconMarketing, IconCart, IconApps } from './chunk-XSFG4ITB.js';
import { cn } from './chunk-HWAWA4NZ.js';
export { cn } from './chunk-HWAWA4NZ.js';
import { createContext, useContext, useState, useRef, useEffect, useMemo, useCallback, useLayoutEffect } from 'react';
...
var PLATFORM_META = {
  ...
  dev: {
    label: "Loce Dev",
    description: "Painel interno da equipe Loce: empresas, planos, assinaturas, usu\xE1rios e suporte.",
    icon: IconCode,
          ...
          if (groupLocked) {
            return /* @__PURE__ */ jsx(
              "span",
              {
                ...
                children: /* @__PURE__ */ jsx(Tooltip, { content: item.subItems[0]?.lockedHint ?? "Chega em breve", side: "right", wrap: true, children: /* @__PURE__ */ jsxs("span", { className: "inline-flex min-w-0 items-center", children: [
                  ...
                  open && /* @__PURE__ */ jsx(IconLock, { size: 12, className: "ml-2 shrink-0 text-foreground/30" })
                ] }) })
              },
              item.label
            );
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { className: "flex size-5 shrink-0 items-center justify-center", children: /* @__PURE__ */ jsx(Icon, { size: 20 }) }),
                  /* @__PURE__ */ jsx(Label, { open, children: item.label }),
                  !singleChild && accordion && /* @__PURE__ */ jsx(
                    IconChevronRight,
                    {
                      size: 12,
                      className: cn(
                  ...
                  if (sub.locked) {
                    return /* @__PURE__ */ jsx(
                      "span",
                      {
                        ...
                        children: /* @__PURE__ */ jsx(Tooltip, { content: sub.lockedHint ?? "Chega em breve", side: "right", wrap: true, children: /* @__PURE__ */ jsxs("span", { className: "inline-flex min-w-0 items-center gap-1.5", children: [
...
function FaceAvatar({ seed, glyph, src, loading, size = 32, className, title }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("span", { className: wrapperClass, style: { width: size, height: size }, "aria-busy": true, children: /* @__PURE__ */ jsx("span", { className: "ds-avatar-loading", "aria-hidden": true }) });
  }
  if (src && !imgError) {
    return /* @__PURE__ */ jsxs(
      "span",
...
function RailUser({ name, email, avatarUrl, loading, badge, children, className }) {
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx(FaceAvatar, { seed, glyph: name?.[0], src: avatarUrl, loading, title: name, size: 28 })
      }
    ) }),
    /* @__PURE__ */ jsxs(DropdownMenuContent, { side: "right", align: "end", sideOffset: 10, className: "w-64 p-1.5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-lg bg-surface-1 p-2.5", children: [
        /* @__PURE__ */ jsx(FaceAvatar, { seed, glyph: name?.[0], src: avatarUrl, loading, title: name, size: 40 }),
        /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-0.5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "truncate text-[13px] font-bold", children: name?.split(" ")[0] }),
            badge
          ] }),
          /* @__PURE__ */ jsx("span", { className: "truncate text-[12px] text-muted-foreground", children: email })
        ] })
      ] }),
...
function Input({ className, label, error, hint, labelAction, suffix, onClear, loading, id, filterActive, ...props }) {
  const hasAdornment = suffix || onClear || loading;
  const input = /* @__PURE__ */ jsx(
    "input",
    {
      id,
      "data-filter-active": filterActive || void 0,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex w-full min-w-0 flex-col gap-1.5", children: [
    ...
    field,
    error ? /* @__PURE__ */ jsx("span", { className: "text-[12px] font-medium text-destructive", children: error }) : hint ? /* @__PURE__ */ jsx("span", { className: "text-[12px] text-muted-foreground", children: hint }) : null
  ] });
}
function SearchInput({ className, onClear, showClear, filterActive, ...props }) {
  return /* @__PURE__ */ jsxs("div", { className: cn("relative flex w-full items-center", className), children: [
    /* @__PURE__ */ jsx(IconSearch, { size: 14, className: cn("pointer-events-none absolute left-3", filterActive ? "text-brand" : "text-muted-foreground") }),
    /* @__PURE__ */ jsx(
      "input",
      {
        "data-filter-active": filterActive || void 0,
...
function Select({ options, value, onChange, placeholder = "Selecionar", label, labelAction, error, loading, disabled, className, filterActive, onClearFilter }) {
  const neutralOption = options.find((opt) => opt.value === "" || opt.value === "all");
  const clearFilter = onClearFilter ?? (neutralOption && onChange ? () => onChange(String(neutralOption.value)) : void 0);
  const selected = options.find((opt) => String(opt.value) === String(value ?? ""));
  const control = /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, disabled: disabled || loading, children: /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        "data-filter-active": filterActive || void 0,
        "aria-invalid": !!error || void 0,
        "aria-label": filterActive ? `${label ?? "Filtro"}: ${selected?.label ?? placeholder} \u2014 aplicado` : void 0,
        title: filterActive ? `Filtro ativo: ${selected?.label ?? placeholder}` : void 0,
        className: cn(
          fieldClass,
          "select-none",
        ...
        children: [
          filterActive && /* @__PURE__ */ jsx(IconFilters, { size: 14, className: "shrink-0", "aria-hidden": "true" }),
          /* @__PURE__ */ jsx("span", { className: "min-w-0 flex-1 truncate", children: selected?.label ?? placeholder }),
          loading ? /* @__PURE__ */ jsx(IconSpinner, { size: 13, className: "shrink-0 animate-spin text-muted-foreground" }) : /* @__PURE__ */ jsx(IconChevronDown, { size: 12, className: "shrink-0 text-muted-foreground" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxs(
      DropdownMenuContent,
      {
        ...
        children: [
          filterActive && clearFilter && /* @__PURE__ */ jsxs(DropdownMenuItem, { onSelect: clearFilter, className: "mb-1 gap-2 border-b border-border pb-2 font-semibold text-brand", children: [
            /* @__PURE__ */ jsx(IconClose, { size: 13 }),
            " Limpar filtro"
          ] }),
          options.map((opt) => {
...
function NativeSelect({ className, options, placeholder, filterActive, ...props }) {
  return /* @__PURE__ */ jsxs("div", { className: cn("relative flex items-center", className), children: [
    /* @__PURE__ */ jsxs("select", { "data-filter-active": filterActive || void 0, title: filterActive ? "Filtro ativo" : props.title, className: cn(fieldClass, "select-none", "cursor-pointer appearance-none pr-8"), ...props, children: [
...
function Switch({ checked, onCheckedChange, disabled, label, description, className, ...props }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-start gap-3", className), children: [
    /* @__PURE__ */ jsx("span", { className: "mt-0.5 flex shrink-0", children: control }),
    /* @__PURE__ */ jsxs("span", { className: "flex min-w-0 flex-col gap-0.5", children: [
      label && /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-foreground", children: label }),
      description && /* @__PURE__ */ jsx("span", { className: "text-xs leading-snug text-muted-foreground", children: description })
    ] })
  ] });
}
...
function Avatar({ name, src, size = 32, className }) {
  ...
  const gradient = GRADIENTS[hashString2(name ?? "?") % GRADIENTS.length];
  return /* @__PURE__ */ jsx(
    "span",
    {
      title: name,
      ...
      children: showImage ? /* @__PURE__ */ jsxs(Fragment, { children: [
        !ready && /* @__PURE__ */ jsx("span", { className: "ds-avatar-loading", "aria-hidden": true }),
        /* @__PURE__ */ jsx(
          "img",
          {
            ref: imgRef,
      ...
      ] }) : /* @__PURE__ */ jsx("span", { className: "font-bold leading-none tracking-wide", children: initialsOf(name) })
    }
  );
}
var TONES = {
...
function SplashScreen({ className }) {
  return /* @__PURE__ */ jsx("main", { className: cn("flex min-h-dvh w-full flex-1 items-center justify-center bg-background", className), children: /* @__PURE__ */ jsx("span", { className: "opacity-0 animate-[ds-overlay-in_0.2s_ease-out_0.25s_forwards]", children: /* @__PURE__ */ jsx(IconSpinner, { size: 22, className: "animate-spin text-brand" }) }) });
}
...
function SkeletonCard({ className }) {
  return /* @__PURE__ */ jsx(Skeleton, { className: cn("h-40 w-full rounded-2xl", className) });
}
...
function MetricCard({ label, value, helper, delta, icon, accent = "brand", loading, className }) {
  if (loading) return /* @__PURE__ */ jsx(Skeleton, { className: cn("h-[104px] rounded-2xl", className) });
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: cn(
  ...
  const field = /* @__PURE__ */ jsxs("div", { ref: wrapperRef, className: "relative w-full min-w-0", children: [
    /* @__PURE__ */ jsx(
      "input",
      {
        ...
        "data-filter-active": filterActive || void 0,
        "aria-invalid": !!error || void 0,
        "aria-label": filterActive ? `${label ?? placeholder} \u2014 filtro ativo` : void 0,
        title: filterActive ? `Filtro ativo: ${value?.label ?? "Selecionado"}` : void 0,
        disabled,
        placeholder,
        value: inputValue,
        autoFocus,
...
function Tabs({ tabs, value, onChange, className, size = "default" }) {
  return /* @__PURE__ */ jsx("div", { className: cn("flex w-fit items-center gap-1 rounded-xl border border-border bg-surface-2/60 p-1", className), children: tabs.map((tab) => {
    ...
    if (tab.disabled) {
      return /* @__PURE__ */ jsx(Tooltip, { content: tab.disabledHint ?? "Chega em breve", side: "top", wrap: true, children: /* @__PURE__ */ jsxs(
        "span",
        {
          "aria-disabled": true,
          className: cn(
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(IconLock, { size: 11, className: "shrink-0 text-muted-foreground/40" })
          ]
        }
      ) }, tab.key);
    }
...
function ModalConfirm({
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-md", children: [
    ...
    children && /* @__PURE__ */ jsx("div", { className: "-mx-6 min-h-0 flex-1 overflow-y-auto px-6 py-1", children }),
...
function ImageUpload({ label, value, onChange, uploadFn, aspect = "square", placeholder, accept = "image/*", className }) {
  const inputRef = useRef(null);
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5", className), children: [
    /* @__PURE__ */ jsx("span", { className: "text-[12px] font-semibold text-foreground/80", children: label }),
    value ? /* @__PURE__ */ jsxs("div", { className: "flex h-24 items-center gap-3 rounded-2xl bg-surface-1 p-3 ring-1 ring-border", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
          src: value,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(IconTrash, { size: 13 }),
              " Remover"
            ]
          }
        )
      ...
      "button",
      {
        ...
        className: cn(
          ...
          dragOver ? "border-brand bg-brand/5 scale-[1.01]" : "border-border hover:border-muted-foreground/50 hover:bg-surface-1"
        ),
        children: [
          /* @__PURE__ */ jsx(
            "span",
            {
              className: cn(
                ...
                dragOver ? "bg-brand/10 text-brand ring-brand/20" : "bg-surface-2 text-muted-foreground ring-border group-hover:text-foreground"
              ),
              children: uploading ? /* @__PURE__ */ jsx(IconSpinner, { size: 22, className: "animate-spin" }) : /* @__PURE__ */ jsx(IconUpload, { size: 22 })
            }
          ),
          /* @__PURE__ */ jsxs("span", { className: "flex flex-col items-start gap-0.5", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-foreground/80", children: uploading ? "Enviando..." : placeholder || "Clique ou arraste uma imagem" }),
            /* @__PURE__ */ jsx("span", { className: "text-[11px] text-muted-foreground", children: "PNG, JPG ou SVG" })
          ] })
        ]
      }
    ),
...
// src/lib/popover.ts
function anchoredPosition(rect, width, viewportWidth, margin = 8) {
...
function DatePicker({ label, value, onChange, placeholder = "Selecione uma data", error, disabled, clearable = true, className, minDate, maxDate, filterActive }) {
  const [open, setOpen] = useState(false);
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex w-full flex-col gap-1.5", className), children: [
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        "data-filter-active": filterActive || void 0,
        "aria-invalid": !!error || void 0,
        "aria-label": filterActive ? `Per\xEDodo: ${formatted || placeholder} \u2014 filtro ativo` : void 0,
        disabled,
        onClick: () => {
          updateCoords();
          setOpen((p) => !p);
        ...
        children: [
          ...
          filterActive && /* @__PURE__ */ jsx("span", { className: "ds-filter-label", "aria-hidden": "true", children: "Filtrado" }),
...
function getPortalContainer2(trigger) {
  if (!trigger) return document.body;
  const radixPortal = trigger.closest("[data-radix-portal]");
  if (radixPortal) return radixPortal;
  return document.body;
}
var fmt = (date) => date.toLocaleDateString("pt-BR", { day: "2-digit", month: "2-digit", year: "numeric" });
function DateRangePicker({
  ...
  const triggerRef = useRef(null);
  const calRef = useRef(null);
  const formatted = value?.from ? value.to && value.to.getTime() !== value.from.getTime() ? `${fmt(value.from)} at\xE9 ${fmt(value.to)}` : fmt(value.from) : "";
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex w-full flex-col gap-1.5", className), children: [
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        "data-filter-active": filterActive || void 0,
        "aria-invalid": !!error || void 0,
        "aria-label": filterActive ? `Per\xEDodo: ${triggerText} \u2014 filtro ativo` : void 0,
        disabled,
        ...
        children: [
          /* @__PURE__ */ jsx(IconCalendar, { size: 15, className: "shrink-0 text-muted-foreground" }),
          /* @__PURE__ */ jsx("span", { className: cn("flex-1 truncate", displayLabel && "text-foreground"), children: triggerText }),
          filterActive && /* @__PURE__ */ jsx("span", { className: "ds-filter-label", "aria-hidden": "true", children: "Filtrado" }),
          value?.from && clearable && /* @__PURE__ */ jsx(
            "span",
            {
              role: "button",
              onClick: (e) => {
    ...
    open && createPortal(
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          className: "fixed z-[100] overflow-hidden rounded-2xl border border-border bg-popover p-1 shadow-xl shadow-black/5 animate-slide-up dark:shadow-black/30",
          children: [
            presets && presets.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center gap-1 border-b border-border px-2 pb-2 pt-1.5", children: presets.map((preset) => /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
                onClick: () => {
                ...
                className: cn(
                  ...
                  preset.key === activePresetKey ? "bg-brand text-white" : "bg-surface-2 text-muted-foreground hover:bg-foreground/[0.08] hover:text-foreground"
                ),
                children: filterActive && preset.key === "all" ? "Limpar filtro \xB7 Todo per\xEDodo" : preset.label
              },
              preset.key
            )) }),
            /* @__PURE__ */ jsx(
              Calendar,
              {
                ...
                selected: pending,
                onSelect: (range) => {
                  if (!pending?.from && range?.from && range.to && range.from.getTime() === range.to.getTime()) {
                    setPending({ from: range.from, to: void 0 });
                    return;
                  }
                  setPending(range);
            ...
            /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between gap-3 px-3 pb-2 pt-1 text-[11px] font-medium text-muted-foreground", children: /* @__PURE__ */ jsx("span", { children: pending?.from && !pending.to ? `In\xEDcio: ${fmt(pending.from)}. Agora clique no fim.` : showCurrent ? "Per\xEDodo atual destacado. Clique no in\xEDcio do novo per\xEDodo." : "Clique no in\xEDcio e depois no fim do per\xEDodo" }) })
          ]
        }
      ),
      getPortalContainer2(triggerRef.current)
    )
  ] });
}
...
// src/lib/filter.ts
var isFilterActive = (value) => value !== void 0 && value !== null && value !== "" && value !== "all";

export { AppShell, Avatar, Badge, BarList, Button, Calendar, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, Checkbox, ComboBox, ConfigCard, DataTable, DatePicker, DateRangePicker, Dialog, DialogBody, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, DropdownActions, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, EmptyState, FaceAvatar, HeaderBar, IconTile, ImageUpload, ImageWithZoom, Input, MetricCard, ModalConfirm, ModalDelete, MultiSelect, NativeSelect, PageShell, PaginationBar, PlatformRail, RailUser, ScrollFade, SearchInput, SegmentedControl, Select, SelectCard, Separator2 as Separator, SheetEntity, SidebarNav, Skeleton, SkeletonCard, SkeletonForm, SkeletonTable, SkeletonText, SplashScreen, StatusDot, Switch, Tabs, TagsInput, Text, TextCopy, Textarea, ThemeToggle, TimeInput, Timeline, Toaster, Tooltip, badgeVariants, buttonVariants, fieldClass, isFilterActive, textVariantMap, useShell };
